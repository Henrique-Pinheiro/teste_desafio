...
public class DriverQA {
    ...
    public List<String> getTextList(String parValue, String... parType) {
    ...
    public void waitForInvisibilityOfElement(String parName, String... parType) {
        final WebDriverWait wait = new WebDriverWait(driver, DEFAULT_WAIT_TIMEOUT);
        final By locator = getLocatorBy(parName, parType);
    ...
    public String getAttributeValue(String identifier, String attribute, String... type) {
